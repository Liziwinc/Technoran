const newsData = [
  {
    title: "Начата работа по благоустройству территории",
    imageLarge: "../img/news_7.jpg",
    image: "../img/news_7.jpg",
    data: "2 Июня",
    text: "Начата работа по благоустройству территории на объекте ООО «Центр пептидных технологий».",
  }, 
  {
    title: "Производятся работы по монтажу лифта",
    imageLarge: "../img/news_6.jpg",
    image: "../img/news_6.jpg",
    data: "26 Мая",
    text: "Производятся работы по монтажу лифта грузоподъемностью 2500 кг.",
  }, 
  {
